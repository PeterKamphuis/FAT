Pro set_warp_slopev3,SBRarr,SBRarr2,cutoff,INCLinput2,PAinput2,INCLinput3,PAinput3,norings,log=log,innerfix=innerfix,sloped=warpconstused
...
;-
  ...
  get_newringsv9,SBRarr,SBRarr2,cutoff,warpconstused,/individual
